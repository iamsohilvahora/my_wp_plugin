...
class Books_Management_Tool {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('admin_menu', $plugin_admin, 'bmt_create_admin_menu_page'); // admin menu page
		
		$this->loader->add_action('wp_ajax_admin_ajax_request', $plugin_admin, 'bmt_handle_admin_ajax_request');
		$this->loader->add_action('wp_ajax_nopriv_admin_ajax_request', $plugin_admin, 'bmt_handle_admin_ajax_request');
	}
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'page_template', $plugin_public, 'bmt_custom_page_template' ); // add page template
		add_shortcode("render_book_content", array($plugin_public, "bmt_render_book_content")); // add shortcode
		$this->loader->add_action('wp_ajax_public_ajax_request', $plugin_public, 'bmt_handle_public_ajax_request');
		$this->loader->add_action('wp_ajax_nopriv_public_ajax_request', $plugin_public, 'bmt_handle_public_ajax_request');
	}
